<template>
  <div class="schedule_view">
    <div class="schedule_view_area" @click="back" />
    <div class="schedule_view_box">
      <div class="schedule_view_header">
        <img class="schedule_view_header_back" src="~/assets/student/schedule/back.png" alt="back" @click="back">
        <img class="schedule_view_header_delete" src="~/assets/student/schedule/delete.png" alt="delete" @click="onDelete">
      ...
      <div class="schedule_view_btn" @click="edit">
        일정 수정하기
      </div>
    </div>
    <schedule-edit
  ...
  methods: {
    ...
    onDelete () {
      this.$swal
        ...
        .then((result) => {
          if (result.value) {
            axios.delete(`${this.$store.state.url}/schedule/${this.event.idx}`)
              .then((res) => {
