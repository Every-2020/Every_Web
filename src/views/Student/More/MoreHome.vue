  ...
  <div class="more">
    ...
    <div class="more_content">
      <div class="more_content_profile">
        ...
        <img @click="goSetting" class="setting_img" src="../../../assets/student/more/setting.png" alt="setting">
      </div>
      <div class="more_content_div">
        <div @click="show" class="more_content_update">
    ...
    <more-popup @onClose="close" v-if="popup"></more-popup>
  </div>
</template>
...
export default {
  ...
  components: { MoreImage, MorePopup },
  mounted() {
