<template>
  <div class="register_form">
    <div class="register_form_header">
      <img @click="back" class="register_form_back" src="../../assets/register/back.png" />
      <div>
    ...
    <div class="register_form_content">
      <div class="register_form_content_left">
        <div class="register_form_container">
          <input class="register_form_input" type="email" placeholder="이메일" v-model="email" />
        ...
        <div class="register_form_container">
          <input maxlength="20" class="register_form_input" type="password" placeholder="비밀번호         8~20자" v-model="pw" />
          <span v-if="pwCheck === 1">잘못된 비밀번호입니다!</span>
          <span v-if="pwCheck === 2">이 입력란을 작성해주세요.</span>
        </div>
        <div class="register_form_container">
          <input class="register_form_input" type="text" placeholder="이름" v-model="name" />
          <span v-if="nameCheck === 2">이 입력란을 작성해주세요.</span>
        </div>
        <div class="register_form_container">
          <input maxlength="4" @keydown="inputBirth" class="register_form_input birth" type="text" placeholder="태어난 년도     ex) 2003" v-model="birth" />
          <span v-if="birthCheck === 1">잘못된 자릿수입니다!</span>
          <span v-if="birthCheck === 2">이 입력란을 작성해주세요.</span>
        </div>
      </div>
      <div class="register_form_content_between">
        <div class="register_form_content_between_line"></div>
      </div>
      <div class="register_form_content_right">
        <div class="register_form_container">
          <input maxlength="13" @keydown="inputPhone" class="register_form_input phone" type="text" placeholder="전화번호" v-model="phone" />
        ...
        <register-student v-if="identity === '학생'" @onSelect="onSelect" :schoolCheck="schoolCheck" />
        <register-worker v-if="identity === '대학생/직장인'" @onCategory="onCategory" @onKeydown="onKeydown" :placeCheck="placeCheck" :categoryCheck="categoryCheck" />
      </div>
    </div>
